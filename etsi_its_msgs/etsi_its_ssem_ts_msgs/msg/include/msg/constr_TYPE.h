...
#include <msg/ber_tlv_length.h>
#include <msg/ber_tlv_tag.h>
...
#include <msg/jer_decoder.h>  /* Decoder of JER (JSON, text) */
#include <msg/jer_encoder.h>  /* Encoder into JER (JSON, text) */
#else
...
#include <msg/per_decoder.h>  /* Packet Encoding Rules decoder */
#include <msg/per_encoder.h>  /* Packet Encoding Rules encoder */
#else
typedef void (per_type_decoder_f)(void);
typedef void (per_type_encoder_f)(void);
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */

#include <msg/constraints.h>  /* Subtype constraints support */

#if !defined(ASN_DISABLE_RFILL_SUPPORT)
#include <msg/asn_random_fill.h>  /* Random structures support */
#else
