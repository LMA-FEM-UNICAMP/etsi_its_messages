...
#include "msg/asn_system.h"		/* for platform-dependent types */
#include "msg/asn_codecs.h"		/* for ASN.1 codecs specifics */
#include "msg/asn_config.h"
...
#include "msg/constr_TYPE.h"	/* for asn_TYPE_descriptor_t */
