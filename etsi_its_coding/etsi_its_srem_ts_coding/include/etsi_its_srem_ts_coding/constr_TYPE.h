...
#include <etsi_its_srem_ts_coding/ber_tlv_length.h>
#include <etsi_its_srem_ts_coding/ber_tlv_tag.h>
...
#include <etsi_its_srem_ts_coding/jer_decoder.h>  /* Decoder of JER (JSON, text) */
#include <etsi_its_srem_ts_coding/jer_encoder.h>  /* Encoder into JER (JSON, text) */
#else
...
#include <etsi_its_srem_ts_coding/per_decoder.h>  /* Packet Encoding Rules decoder */
#include <etsi_its_srem_ts_coding/per_encoder.h>  /* Packet Encoding Rules encoder */
#else
typedef void (per_type_decoder_f)(void);
typedef void (per_type_encoder_f)(void);
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */

#include <etsi_its_srem_ts_coding/constraints.h>  /* Subtype constraints support */

#if !defined(ASN_DISABLE_RFILL_SUPPORT)
#include <etsi_its_srem_ts_coding/asn_random_fill.h>  /* Random structures support */
#else
